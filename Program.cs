namespace ProjetPSI
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                noeuds[i] = new Noeud<int> (i+1, tableau_nomStation[i], "blanc", ListeAdjacence[i]);            /// Tous les noeuds de graphe prennent en paramètre un numéro i, la couleur blanche et une liste de voisins correspondant à la liste d'adjacence du sommet étudié.
            }
            ...
            graphe.AlgorithmeDijkstra(noeuds, liens, ordre);
